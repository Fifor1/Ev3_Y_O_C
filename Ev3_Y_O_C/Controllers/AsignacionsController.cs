...
namespace Ev3_Y_O_C.Controllers
{
    public class AsignacionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioId,HerramientaId,FechaAsignacion,FechaRetorno")] Asignacion asignacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UsuarioId,HerramientaId,FechaAsignacion,FechaRetorno")] Asignacion asignacion)
        {
            if (id != asignacion.Id)
            {
                return NotFound();
