...
namespace Ev3_Y_O_C.Controllers
{
    public class ModeloHerramientasController : Controller
    {
        ...
        {
            var aspWebContext = _context.ModelosHerramienta.Include(m => m.Marca);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var modeloHerramienta = await _context.ModelosHerramienta
                .Include(m => m.Marca)
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,MarcaId")] ModeloHerramienta modeloHerramienta)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var modeloHerramienta = await _context.ModelosHerramienta.FindAsync(id);
            if (modeloHerramienta == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,MarcaId")] ModeloHerramienta modeloHerramienta)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (modeloHerramienta != null)
            {
                _context.ModelosHerramienta.Remove(modeloHerramienta);
            }
